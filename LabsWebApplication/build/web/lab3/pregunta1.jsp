...
<html>
    ...
    <body>
        ...
        <ul class="nav nav-tabs nav-fill">
            <li class="nav-item">
                <a class="nav-link active" href="<%=laboratorio.Laboratorio.getRoot()%>lab3/pregunta1.jsp">Pregunta 1</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<%=laboratorio.Laboratorio.getRoot()%>lab3/pregunta2.jsp">Pregunta 2</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<%=laboratorio.Laboratorio.getRoot()%>lab3/pregunta3.jsp">Pregunta 3</a>
            </li>
        </ul>
            
        <!-- PREGUNTA -->
        <form style="margin-top: 30px" class="text-center border border-light p-5" action="pregunta1.jsp" method="POST">
            <p class="h4 mb-4">PDF: GENERAR MATRÍZ</p>
