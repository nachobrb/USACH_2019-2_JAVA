...
<html>
    ...
    <body>
        ...
        <!-- PAGE CONTENT -->
        <div class="container" style="margin-top: 30px"><div class="jumbotron">
            <h2 class="display-4">Laboratorios!</h2>
            <p class="lead">La barra de navegación contiene los links correspondientes al desarrollo de los laboratorios.</p>
            <hr class="my-5">
            <p>Desarrollado por Ignacio Olave</p>
            <p>Universidad de Santiago de Chile</p>
            <p>Licenciatura en Ciencia de la Computación</p>
        </div></div>
