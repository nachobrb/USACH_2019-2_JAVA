...
<html>
    ...
    <body>
        ...
        <ul class="nav nav-tabs nav-fill">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="<%=laboratorio.Laboratorio.getRoot()%>lab2/pregunta2.jsp">Pregunta 2</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<%=laboratorio.Laboratorio.getRoot()%>lab2/pregunta5.jsp">Pregunta 5</a>
            </li>
        </ul>
            
        <!-- PREGUNTA -->
        <form style="margin-top: 30px" class="text-center border border-light p-5" action="pregunta2.jsp" method="POST">
            <p class="h4 mb-4">ELIMINAR VOCALES</p>
            <input type="text" class="form-control mb-4" name="c1" placeholder="Cadena 1">
            <input type="text" class="form-control mb-4" name="c2" placeholder="Cadena 2">
            <input type="text" class="form-control mb-4" name="c3" placeholder="Cadena 3">
            <input type="text" class="form-control mb-4" name="c4" placeholder="Cadena 4">
            <input type="text" class="form-control mb-4" name="c5" placeholder="Cadena 5">
            <button class="btn btn-info btn-block my-4" type="submit">Enviar</button>
            <%=
                laboratorio.lab2.pregunta2(
