...
<html>
    ...
    <body>
        ...
        <ul class="nav nav-tabs nav-fill">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="<%=laboratorio.Laboratorio.getRoot()%>lab1/pregunta3.jsp">Pregunta 3</a>
            </li>
            <li class="nav-item">
        ...
        <form style="margin-top: 30px" class="text-center border border-light p-5" action="pregunta3.jsp" method="get">
            ...
            <input type="text" class="form-control mb-4" name="n3" placeholder="Tercer número">
            <button class="btn btn-info btn-block my-4" type="submit">Enviar</button>
            <%=
                laboratorio.lab1.pregunta3(
